...
#     t0 = time.ticks_us()
    ...
    x_arr_corr, y_arr_corr, z_arr_corr = x_arr + calibration_offset[0], y_arr + calibration_offset[1], z_arr + calibration_offset[2]
...
#     fft_x[0], fft_y[0], fft_z[0] = 0,0,0 # remove DC component in FFT
    ...
    rms_x =  math.sqrt(float(np.sum(x_arr_corr**2)) / FFT_SIZE)
